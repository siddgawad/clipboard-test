...
@Controller("shifts") // this class decorator tells Nest that this class handles HTTP routes
export class ShiftsController {
  ...
  async get(
    ...
    // output; it is safety-critical; ps- smart, good idea but i don't think anyone would fall for this 
